  ...
  public Value invokeMethod(String name, Value[] args, History history) {
    if (name.equals("<init>")) {
      ...
      if (args[0] instanceof SqlDateObjectValue) {
        ...
        IntValue ret2 =
            new IntValue((int) ret.concrete, ret.symbolic.setop(SymbolicInt.COMPARISON_OPS.GT));
        return ret2;
      }
      ...
      if (args[0] instanceof SqlDateObjectValue) {
        ...
        IntValue ret2 =
            new IntValue((int) ret.concrete, ret.symbolic.setop(SymbolicInt.COMPARISON_OPS.LT));
        return ret2;
      }
