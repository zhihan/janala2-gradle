...
public class YicesSolver2 implements Solver {
  ...
  public boolean solve() {
    try {
      PrintStream out =
          new PrintStream(
              new BufferedOutputStream(new FileOutputStream(Config.instance.formulaFile)));
      ...
      ProcessBuilder builder =
          new ProcessBuilder(
              new String[] {Config.instance.yicesCommand, Config.instance.formulaFile});
      ...
      if (!line.startsWith("sat")) {
        if (!line.contains("unsat")) {
          ...
          logger.log(
              Level.SEVERE,
              "Call to Yices failed (concolic.yices = " + Config.instance.yicesCommand + ")");
